...
def cancel_sucess(request):
    return render(request,'cancel_sucess.html')
#-------------------------------------------------------------
...
def search(request):
    ...
    return render(request, 'search_train.html', {'stations': stations,'stationss': stationss,'all_from_stations': all_from_stations, 'all_destinations': all_destinations,'x':x})
